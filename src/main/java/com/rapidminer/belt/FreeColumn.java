...
/**
 * Column with object data that is not categorical. Data can be accessed via a {@link ObjectColumnReader}.
 *
 * @author Gisa Meier
 */
abstract class FreeColumn<R> extends Column {
	...
	FreeColumn(ColumnType<R> type, int size) {
