 ...
 * @author Gisa Meier
 */
final class ApplierNCategoricalToCategorical<T> implements ParallelExecutor.Calculator<CategoricalBuffer<T>> {
	...
	ApplierNCategoricalToCategorical(Column[] sources, Function<CategoricalRow, T> operator, IntegerFormats.Format format) {
