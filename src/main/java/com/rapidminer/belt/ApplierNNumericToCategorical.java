 ...
 * @author Gisa Meier
 */
final class ApplierNNumericToCategorical<T> implements ParallelExecutor.Calculator<CategoricalBuffer<T>> {
	...
	ApplierNNumericToCategorical(Column[] sources, Function<NumericRow, T> operator, IntegerFormats.Format format) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<NumericRow, T> operator, Int32CategoricalBuffer<T> target,
									int from, int to) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<NumericRow, T> operator, UInt16CategoricalBuffer<T> target,
									int from, int to) {
		final NumericRowReader reader = new NumericRowReader(sources);
		reader.setPosition(from - 1);
		for (int i = from; i < to; i++) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<NumericRow, T> operator, UInt8CategoricalBuffer<T> target,
									int from, int to) {
		final NumericRowReader reader = new NumericRowReader(sources);
		reader.setPosition(from - 1);
		for (int i = from; i < to; i++) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<NumericRow, T> operator, UInt4CategoricalBuffer<T> target,
									int from, int to) {
		final NumericRowReader reader = new NumericRowReader(sources);
		reader.setPosition(from - 1);
		for (int i = from; i < to; i++) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<NumericRow, T> operator, UInt2CategoricalBuffer<T> target,
									int from, int to) {
		final NumericRowReader reader = new NumericRowReader(sources);
		reader.setPosition(from - 1);
		for (int i = from; i < to; i++) {
