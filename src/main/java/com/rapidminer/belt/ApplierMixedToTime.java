 ...
 * @author Gisa Meier
 */
final class ApplierMixedToTime implements ParallelExecutor.Calculator<TimeBuffer> {
	...
	ApplierMixedToTime(Column[] sources, Function<MixedRow, LocalTime> operator) {
	 ...
	 */
	private static void mapPart(final Column[] sources, final Function<MixedRow, LocalTime> operator,
