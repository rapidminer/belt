...
/**
 * A {@link ColumnBuffer} that can change its size and contains double values without fractional digits. If the size is
 * fixed, a {@link FixedIntegerBuffer} should be used instead.
 *
 * @author Gisa Meier
 */
public final class GrowingIntegerBuffer extends GrowingColumnBuffer {
	 ...
	 */
	GrowingIntegerBuffer(int length) {
		if (length < 0) {
