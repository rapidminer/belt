 ...
 * IntegerFormats.Format#UNSIGNED_INT8} that can hold {@link 255} many different categories. The category indices are
 * stored as {@code byte}.
 * <p>
 ...
 * @see Buffers
 */
public final class UInt8CategoricalBufferSparse<T> extends CategoricalBufferSparse<T> {
	 ...
	 */
	private final Map<T, Byte> indexLookup;
	 ...
	 */
	UInt8CategoricalBufferSparse(T defaultValue, int length) {
		if (length < 0) {
