...
/**
 * Implementation of a {@link NominalBuffer} with category index format {@link Format#UNSIGNED_INT4} that can
...
public class UInt4NominalBuffer extends NominalBuffer {
	 ...
	 */
	UInt4NominalBuffer(ColumnType<String> type, int length) {
		super(type);
