...
public abstract class CategoricalBuffer<T> {
	...
	/**
	 * Creates a boolean column with the given positive value. If the positive value is {@code null}, all values of the
	 * resulting column convert to {@code false}.
	 *
	 * @param type
	 ...
	 * 		if the given positive value is not one of the values
	 */
