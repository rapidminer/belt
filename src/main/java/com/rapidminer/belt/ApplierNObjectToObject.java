 ...
 * @author Gisa Meier
 */
final class ApplierNObjectToObject<R, T> implements ParallelExecutor.Calculator<ObjectBuffer<T>> {
	...
	ApplierNObjectToObject(Column[] sources, Class<R> type, Function<ObjectRow<R>, T> operator) {
