 ...
 * @author Gisa Meier
 */
final class ApplierNNumericToTime implements ParallelExecutor.Calculator<TimeBuffer> {
	...
	ApplierNNumericToTime(Column[] sources, Function<NumericRow, LocalTime> operator) {
	 ...
	 */
	private static void mapPart(final Column[] sources, final Function<NumericRow, LocalTime> operator,
