 ...
 * @author Gisa Meier
 */
final class ApplierMixedToNumeric implements ParallelExecutor.Calculator<NumericBuffer> {
	...
	ApplierMixedToNumeric(Column[] sources, ToDoubleFunction<MixedRow> operator, boolean round) {
	 ...
	 */
	private static void mapPart(final Column[] sources, final ToDoubleFunction<MixedRow> operator,
