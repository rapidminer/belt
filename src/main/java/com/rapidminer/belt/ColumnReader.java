...
public final class ColumnReader {
	 ...
	 */
	static final int SMALL_BUFFER_SIZE = 256;
	 ...
	 */
	public ColumnReader(Column src) {
		this(src, DEFAULT_BUFFER_SIZE, src.size());
	}
	 ...
	 *             if the source column is {@code null}
	 */
	public ColumnReader(Column src, int length) {
		this(src, DEFAULT_BUFFER_SIZE, length);
	}
	 ...
	 *             if the source column is {@code null}
	 */
	ColumnReader(Column src, int bufferSizeHint, int length) {
