 ...
 * @author Gisa Meier
 */
final class MixedColumnsReducer<T> implements ParallelExecutor.Calculator<T> {
	...
	MixedColumnsReducer(Column[] sources, Supplier<T> supplier, BiConsumer<T, MixedRow> reducer, BiConsumer<T, T> combiner) {
	 ...
	 */
	private static <T> void reducePart(Column[] sources, T container, BiConsumer<T, MixedRow> reducer, int from, int to) {
