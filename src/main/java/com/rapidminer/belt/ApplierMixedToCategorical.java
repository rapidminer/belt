 ...
 * @author Gisa Meier
 */
final class ApplierMixedToCategorical<T> implements ParallelExecutor.Calculator<CategoricalBuffer<T>> {
	...
	ApplierMixedToCategorical(Column[] sources, Function<MixedRow, T> operator, IntegerFormats.Format
			format) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<MixedRow, T> operator,
