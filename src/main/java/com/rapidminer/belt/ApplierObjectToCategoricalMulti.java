 ...
 * @author Gisa Meier
 */
final class ApplierObjectToCategoricalMulti<R, T> implements ParallelExecutor.Calculator<CategoricalColumnBuffer<T>> {
	...
	ApplierObjectToCategoricalMulti(Column[] sources, Class<R> type, Function<ObjectRow<R>, T> operator, IntegerFormats.Format format) {
