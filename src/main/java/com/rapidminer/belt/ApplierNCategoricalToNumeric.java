 ...
 * @author Gisa Meier
 */
final class ApplierNCategoricalToNumeric implements ParallelExecutor.Calculator<NumericBuffer> {
	...
	ApplierNCategoricalToNumeric(Column[] sources, ToDoubleFunction<CategoricalRow> operator, boolean round) {
	 ...
	 */
	private static void mapPart(final Column[] sources, final ToDoubleFunction<CategoricalRow> operator, final NumericBuffer target,
								int from, int to) {
