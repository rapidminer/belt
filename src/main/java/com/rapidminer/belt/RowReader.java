 ...
 * }</pre>
 *
 * <p>Given the column-oriented design of Belt, {@link RowReader}s do not perform as well as {@link ColumnReader}s.
 * Thus, whenever possible the use of {@link ColumnReader}s is preferred.
 *
 * @author Michael Knopf
 */
public final class RowReader implements Row {
	 ...
	 */
	public RowReader(Column first, Column second, Column... columns) {
	 ...
	 * 		if the source columns array is {@code null}
	 */
	RowReader(Column[] src, int bufferElementsHint) {
