 ...
 * @author Gisa Meier
 */
final class CategoricalColumnsReducer<T> implements ParallelExecutor.Calculator<T> {
	...
	CategoricalColumnsReducer(Column[] sources, Supplier<T> supplier, BiConsumer<T, CategoricalRow> reducer, BiConsumer<T, T> combiner) {
	 ...
	 */
	private static <T> void reducePart(Column[] sources, T container, BiConsumer<T, CategoricalRow> reducer, int from, int to) {
