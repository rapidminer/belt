...
/**
 * Maps {@link Column.Category#CATEGORICAL} {@link Column}s to a {@link TimeColumnBuffer} using a given mapping
 * operator.
 *
 * @author Gisa Meier
 */
final class ApplierCategoricalToTimeMulti implements ParallelExecutor.Calculator<TimeColumnBuffer> {

	private TimeColumnBuffer target;
	private final Column[] sources;
	private final Function<CategoricalRow, LocalTime> operator;

	ApplierCategoricalToTimeMulti(Column[] sources, Function<CategoricalRow, LocalTime> operator) {
