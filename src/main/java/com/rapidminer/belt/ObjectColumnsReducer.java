 ...
 * @author Gisa Meier
 */
final class ObjectColumnsReducer<T,R> implements ParallelExecutor.Calculator<T> {
	...
	ObjectColumnsReducer(Column[] sources, Class<R> type, Supplier<T> supplier, BiConsumer<T, ObjectRow<R>> reducer,
	 ...
	 */
	private static <T,R> void reducePart(Column[] sources, Class<R> type, T container,
