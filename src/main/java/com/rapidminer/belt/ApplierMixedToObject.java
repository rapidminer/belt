 ...
 * @author Gisa Meier
 */
final class ApplierMixedToObject<T> implements ParallelExecutor.Calculator<ObjectBuffer<T>> {
	...
	ApplierMixedToObject(Column[] sources, Function<MixedRow, T> operator) {
	 ...
	 */
	private static <T> void mapPart(final Column[] sources, final Function<MixedRow, T> operator,
