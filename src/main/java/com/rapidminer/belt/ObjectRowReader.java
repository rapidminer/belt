...
public final class ObjectRowReader<T> implements ObjectRow<T>{
	...
	/**
	 * Creates a new reader for row-wise reads of all the columns in the given table. The columns must have the
	 ...
	 * 		the table to read
	 * @param type
	 * 		the common superclass of all the element types of the columns in the table
	...
	/**
	 * Creates a new reader for row-wise reads of the given columns. The columns must have the capability {@link
	 ...
	 */
	ObjectRowReader(Column[] src, Class<T> type, int bufferElementsHint) {
