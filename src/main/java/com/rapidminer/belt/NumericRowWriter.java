...
public final class NumericRowWriter {
	 ...
	 */
	NumericRowWriter(List<String> columnLabels) {
	 ...
	 */
	NumericRowWriter(List<String> columnLabels, List<ColumnType<Void>> types) {
		int numberOfColumns = columnLabels.size();
		columns = new NumericColumnWriter[numberOfColumns];
		this.columnLabels = columnLabels.toArray(new String[0]);
		for (int i = 0; i < numberOfColumns; i++) {
	 ...
	 */
	NumericRowWriter(List<String> columnLabels, int expectedRows) {
		int numberOfColumns = columnLabels.size();
		columns = new NumericColumnWriter[numberOfColumns];
		this.columnLabels = columnLabels.toArray(new String[0]);
		for (int i = 0; i < numberOfColumns; i++) {
	 ...
	 * 		the expected number of rows
	 */
	NumericRowWriter(List<String> columnLabels, List<ColumnType<Void>> types, int expectedRows) {
		int numberOfColumns = columnLabels.size();
		columns = new NumericColumnWriter[numberOfColumns];
		this.columnLabels = columnLabels.toArray(new String[0]);
		for (int i = 0; i < numberOfColumns; i++) {
