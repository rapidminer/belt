...
/**
 * Maps arbitrary {@link Column}s to a {@link CategoricalColumnBuffer} using a given mapping operator.
 *
 * @author Gisa Meier
 */
final class ApplierGeneralToCategoricalMulti<T> implements ParallelExecutor.Calculator<CategoricalColumnBuffer<T>> {
	...
	ApplierGeneralToCategoricalMulti(Column[] sources, Function<GeneralRow, T> operator, IntegerFormats.Format
			format) {
	 ...
	 */
	private static <T> void mapPart(Column[] sources, Function<GeneralRow, T> operator,
