...
/**
 * A row of a {@link Table} that supports reading different formats. In contrast to {@link Row}, {@link CategoricalRow}
 * and {@link ObjectRow}, a {@link GeneralRow} allows to read the entries as numbers, category indices or objects at the
 * same time.
 *
 * @author Gisa Meier
 * @see GeneralRowReader
 */
public interface GeneralRow {
	 ...
	 * {@link Column.Category#CATEGORICAL} column. Returns {@code 0} in case of a {@link Column.Category#FREE} column
