 ...
 * @author Gisa Meier
 */
final class ApplierNCategoricalToObject<T> implements ParallelExecutor.Calculator<ObjectBuffer<T>> {
	
	private ObjectBuffer<T> target;
	private final Column[] sources;
	private final Function<CategoricalRow, T> operator;

	ApplierNCategoricalToObject(Column[] sources, Function<CategoricalRow, T> operator) {
