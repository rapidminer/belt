...
public class CategoricalRowReaderTests {
	...
	public static class Reading {
		...
		public void testReadingFromSingleCompleteBuffer() {
			...
			Arrays.setAll(columns, i -> new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL, inputs[i], new ArrayList<>()));
		...
		public void testReadingFromTwoColumns() {
			...
			Column[] columns = new Column[]{new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL, input0, new ArrayList<>()),
					new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL, input1, new ArrayList<>()),
					new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL, input2, new ArrayList<>())};

			CategoricalRowReader reader = new CategoricalRowReader(columns[2], columns[0]);
			int[][] outputs = readAllColumnsToArrays(reader);
		...
		public void testReadingWholeTable() {
			...
			CategoricalRowReader reader = new CategoricalRowReader(table);
			int[][] outputs = readAllColumnsToArrays(reader);
		...
		public void testReadingFromThreeColumns() {
			...
			CategoricalRowReader reader = new CategoricalRowReader(table.column("c"), table.column("b"), table.column("a"));
			int[][] outputs = readAllColumnsToArrays(reader);
		...
		public void testColumnInteractionWithSingleBuffer() {
			...
			Column[] columns = new Column[nColumns];
			Arrays.setAll(columns, i -> spy(new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL, inputs[i], new ArrayList<>())));
	...
	public static class Remaining {
		...
		public void testInitialRemainder() {
			...
			Column[] columns = new Column[nColumns];
			Arrays.setAll(columns, i -> new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL, new int[nRows], new ArrayList<>()));
