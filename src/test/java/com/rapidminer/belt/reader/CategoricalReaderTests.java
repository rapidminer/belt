...
public class CategoricalReaderTests {
	...
	public static class Reading {
		...
		public void testReadingFromSingleCompleteBuffer() {
			...
			CategoricalReader reader = Readers.categoricalReader(
					ColumnTestUtils.getCategoricalColumn(ColumnTypes.NOMINAL, input, new ArrayList<>()));
		...
		public void testColumnInteractionWithSingleBuffer() {
			Column column = spy(ColumnTestUtils.getCategoricalColumn(ColumnTypes.NOMINAL,
	...
	public static class Remaining {
		...
		public void testInitialRemainder() {
			int n = 64;
			Column column = ColumnTestUtils.getCategoricalColumn(ColumnTypes.NOMINAL, new int[n],
					new ArrayList<>());
		...
		public void testRemainder() {
			int n = 64;
			int reads = 16;
			Column column = ColumnTestUtils.getCategoricalColumn(ColumnTypes.NOMINAL, new int[n], new ArrayList<>());
			CategoricalReader reader = Readers.categoricalReader(column, column.size());
	...
	public static class Position {
		...
		public void testSet() {
			...
			Column column = ColumnTestUtils.getCategoricalColumn(ColumnTypes.NOMINAL, testArray, new ArrayList<>());
			CategoricalReader reader = new CategoricalReader(column, 10, column.size());
