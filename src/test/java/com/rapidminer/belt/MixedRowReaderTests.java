...
public class MixedRowReaderTests {
	...
	public static class FactoryMethods {
		...
		@Test(expected = NullPointerException.class)
		public void testNullColumnArray() {
			Readers.mixedRowReader((Column[]) null);
		}
		...
		@Test(expected = NullPointerException.class)
		public void testNullColumnArrayElement() {
			Readers.mixedRowReader(new Column[]{null});
		}

		@Test(expected = NullPointerException.class)
		public void testNullFirstColumn() {
			Column column = new DoubleArrayColumn(Column.TypeId.REAL, new double[0]);
	...
	public static class Reading {
		...
		public void testReadingDifferentCategories() {
			...
			Column[] columns = new Column[]{
					...
					new SimpleObjectColumn<>(ColumnTypes.freeType("test", String.class, null), input3)
			};
		...
		public void testReadingFromColumnArray() {
			...
			MixedRowReader reader = Readers.mixedRowReader(columns);
			double[][] outputs = readAllColumnsToRealArrays(reader);
			int[][] indexOutputs = readAllColumnsToIndexArrays(reader);
			Object[][] objectOutputs = readAllColumnsToObjectArrays(reader);
		...
		public void testColumnInteractionWithSingleBufferFree() {
			...
			Column[] columns = new Column[nColumns];
			Arrays.setAll(columns, i -> spy(new SimpleObjectColumn<>(
	...
	public static class Remaining {
		...
		public void testEmptyArray() {
			MixedRowReader reader = new MixedRowReader(new Column[0]);
	...
	public static class Position {
		...
		public void testGetBufferSmaller() {
			...
			MixedRowReader reader = new MixedRowReader(columns, 10 * nColumns);
			for (int i = 0; i < nReads; i++) {
				reader.move();
			}
