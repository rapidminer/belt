...
public class DictionaryTests {
	...
	public void testToString() {
		Dictionary dic = new Dictionary(Arrays.asList(null, "bla", "blub", "blubblub"));
		assertEquals("Dictionary [null, bla, blub, blubblub]", dic.toString());
	}

	@Test
	public void testBooleanToString() {
		Dictionary dic = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
		assertEquals("Dictionary [null, bla, blub], positive: bla", dic.toString());
	}

	@Test
	public void testBooleanToStringNoPositive() {
		Dictionary dic = new BooleanDictionary(Arrays.asList(null, "bla"), -1);
	...
	public void testBooleanDictWithNull() {
		Dictionary dict = new BooleanDictionary(Arrays.asList(null, null, "bla"), 2);
	...
	public void testBooleanDictWithNullNegative() {
		Dictionary dict = new BooleanDictionary(Arrays.asList(null, null, "bla"), -1);
		assertTrue(dict.isBoolean());
	...
	public void testBooleanDictNegative() {
		Dictionary dict = new BooleanDictionary(Arrays.asList(null, "bla", "blup"), 1);
		assertEquals(2, dict.getNegativeIndex());
	...
	@Test
	public void testGet() {
		Dictionary dict = new Dictionary(Arrays.asList(null, "bla", null, null, "blup"), 2);
	...
	public void testIterator() {
		Dictionary dic = new Dictionary(Arrays.asList(null, "1", "2", "3", "4", "5"));
		int index = 1;
	...
	public void testIteratorUnused() {
		Dictionary dic = new Dictionary(Arrays.asList(null, "1", "2", null, null, "5", "6", "7", null, "9"));
		int count = 0;
		for (Dictionary.Entry e : dic) {
	...
	public void testInverse() {
		Dictionary dic = new Dictionary(Arrays.asList(null, "a", "b", "c", "d", "e"));
	...
	public void testBooleanEquals() {
		BooleanDictionary dic1 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
		BooleanDictionary dic2 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
	...
	public void testBooleanNotEqualIndex() {
		BooleanDictionary dic1 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
		BooleanDictionary dic2 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 2);
	...
	public void testBooleanNotEqualDic() {
		BooleanDictionary dic1 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
		BooleanDictionary dic2 = new BooleanDictionary(Arrays.asList(null, "bla"), 1);
		assertFalse(dic1.equals(dic2));
	}

	@Test
	public void testBooleanNotEqualNonBooleanDic() {
		Dictionary dic1 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
		Dictionary dic2 = new Dictionary(Arrays.asList(null, "bla", "blub"));
		assertFalse(dic1.equals(dic2));
	...
	public void testBooleanEqualsSame() {
		BooleanDictionary dic1 = new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 1);
		BooleanDictionary dic2 = dic1;
		assertTrue(dic1.equals(dic2));
	}

	@Test
	public void testEquals() {
		Dictionary dic1 = new Dictionary(Arrays.asList(null, "bla", "blub"));
		Dictionary dic2 = new Dictionary(Arrays.asList(null, "bla", "blub"));
		assertTrue(dic1.equals(dic2));
	}
	...
	public void testNotEquals() {
		Dictionary dic1 = new Dictionary(Arrays.asList(null, "bla", "blub"));
		Dictionary dic2 = new Dictionary(Arrays.asList(null, "bla", "blub", "blip"));
		assertFalse(dic1.equals(dic2));
	}

	@Test
	public void testToBoolean() {
		Dictionary dic = new Dictionary(Arrays.asList(null, "bla", "blub"));
	...
	public void testToBooleanNull() {
		Dictionary dic = new Dictionary(Arrays.asList(null, "bla"));
		assertEquals(new BooleanDictionary(Arrays.asList(null, "bla"), -1), dic.toBoolean(null));
	}

	@Test
	public void testToBooleanWithNewPositiveValue(){
		Dictionary oneElementDic = new Dictionary(Arrays.asList(null, "bla"));
		assertFalse(oneElementDic.isBoolean());
		assertEquals(new BooleanDictionary(Arrays.asList(null, "bla", "blub"), 2), oneElementDic.toBoolean("blub"));

		Dictionary noElementDic = new Dictionary(Collections.singletonList(null));
		assertFalse(noElementDic.isBoolean());
		assertEquals(new BooleanDictionary(Arrays.asList(null, "blub"), 1), noElementDic.toBoolean("blub"));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testPositiveValueNotInDictionary(){
		Dictionary dic = new Dictionary(Arrays.asList(null, "bla", "blub"));
		assertFalse(dic.isBoolean());
		dic.toBoolean("nope");
	}
	...
	@Test(expected = IllegalArgumentException.class)
	public void testPositiveValueNotInDictionaryNull(){
		Dictionary dic = new Dictionary(Arrays.asList(null, "bla", "blub"));
		assertFalse(dic.isBoolean());
		dic.toBoolean(null);
	}
