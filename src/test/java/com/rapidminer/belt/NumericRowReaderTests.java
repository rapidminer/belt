...
public class NumericRowReaderTests {
	...
	public static class FactoryMethods {
		...
		public void testNullColumnArray() {
			Readers.numericRowReader((Column[]) null);
		}
		...
		public void testNullColumnArrayElement() {
			Readers.numericRowReader(new Column[]{null});
		}
	...
	public static class Reading {
		...
		public void testReadingFromSingleCompleteBuffer() {
			...
			NumericRowReader reader = new NumericRowReader(columns);
		...
		public void testReadingFromColumnArray() {
			...
			NumericRowReader reader = Readers.numericRowReader(new Column[]{table.column("c"),
					table.column("b"),
					table.column("a")});
			double[][] outputs = readAllColumnsToArrays(reader);
	...
	public static class Position {
		...
		public void testGetBufferSmaller() {
			...
			NumericRowReader reader = new NumericRowReader(columns, 10 * nColumns);
			for (int i = 0; i < nReads; i++) {
				reader.move();
			}
