...
public class ObjectReaderTests {
	...
	private static Column column(String columnImplementation, String[] data) {
		switch (columnImplementation) {
			...
			case OBJECT:
				return new SimpleObjectColumn<>(ColumnTypes.freeType("com.rapidminer.belt.column.test.stringcolumn",
	...
	public static class FactoryMethods {
		...
		public void testNullType() {
			CategoricalColumn<String> column = new SimpleCategoricalColumn<>(ColumnTypes.NOMINAL,
					new int[0],
