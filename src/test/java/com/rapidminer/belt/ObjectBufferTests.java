...
public class ObjectBufferTests {
	...
	public void testFromFreeColumn() {
		...
		ObjectColumn<String> column = new SimpleObjectColumn<>(ColumnTypes.freeType("com.rapidminer.belt.column.test.stringcolumn",
	...
	public void testFromMappedFreeColumn() {
		...
		MappedObjectColumn<String> column = new MappedObjectColumn<>(ColumnTypes.freeType(
