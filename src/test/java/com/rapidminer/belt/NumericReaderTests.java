...
public class NumericReaderTests {
	...
	public static class Reading {
		...
		public void testReadingFromSingleCompleteBuffer() {
			...
			NumericReader reader = new NumericReader(new DoubleArrayColumn(input), NumericReader.DEFAULT_BUFFER_SIZE,
					input.length);
		...
		public void testColumnInteractionWithSingleBuffer() {
			Column column = spy(new DoubleArrayColumn(new double[NumericReader.DEFAULT_BUFFER_SIZE]));
		...
		public void testColumnInteractionWithMultipleBuffers() {
			Column column = spy(new DoubleArrayColumn(new double[3 * NumericReader.DEFAULT_BUFFER_SIZE]));
			NumericReader reader = new NumericReader(column, NumericReader.DEFAULT_BUFFER_SIZE, column.size());
			readAll(reader);
